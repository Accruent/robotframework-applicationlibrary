...
class MobileLibrary(AppiumLibrary):
    """ApplicationLibrary Mobile Library
    ...
    def _scroll_to_text(self, text, swipe_direction, swipe_count=10):
        ...
        for _ in range(swipe_count):
            ...
            if swipe_direction.lower() == 'up':
                ...
                appLib.fail("Swipe_direction: " + swipe_direction + "is not implemented.")
        appLib.fail("Text: " + text + " was not found after " + str(swipe_count) + " swipes")
